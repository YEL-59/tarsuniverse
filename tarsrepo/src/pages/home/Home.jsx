			...
			<div class=" flex justify-evenly items-center    gap-5  flex-col  lg:flex-row   p-2 lg:p-0 ">
				{/**left flex..start */}
					...
					<div className="p-2  lg:p-0 ">
						...
						<h2 className='text-lg  lg:text-4xl text-white lg:text-start font-semibold  mb-5'>with Genex Properties Ltd</h2>
						<p className='text-sm lg:text-lg text-white  max-w-lg'>TARS BINARY is a technology company where we are designing and developing technologies for military intelligence, law enforcement agency, and a vast area of Engineering Education Media for the first time in the globe.
