  ...
  return (
    <div className=" bg-black   text-white ">
      ...
      <div className="mt-10 p-5 container mx-auto">
        <div className="flex justify-between flex-col text-center lg:text-start md:flex-row">
          <div>
            ...
            <div className="flex  justify-center gap-2">
              ...
              <div>
                <LinkedInIcon style={{color:grey[500]}} />
              </div>{" "}
              <div>
              ...
              <div>
                <YouTubeIcon style={{color:grey[500]}} />
              </div>
			  <div>
...
<div className="flex flex-col lg:flex-row text-center lg:text-start gap-16">
<div>
            <ul>
      ...
      <div className="flex flex-col lg:flex-row text-center lg:text-start justify-center mt-10 mb-5 gap-5 ">
        <p>Privacy&Policy</p>
        <p>Legal Papers</p>
        <p>Documents</p>
      ...
      <div className=" text-xsm  text-center bg-black w-full">
        <div className="flex flex-col lg:flex-row text-white  justify-evenly items-center">
          <div className="text-center font-normal py-2">
